...
在block中解决循环引用要追寻的[2011 WWDC Session #322](https://developer.apple.com/videos/play/wwdc2011-322/) 当时惊艳的代码是这样的：
...
或者可以看看[AFNetWorking](https://github.com/AFNetworking)是这样用block的:
...
[原文](http://kelan.io/2015/the-weak-strong-dance-in-swift/)
...
其实Swift中闭包的参数列表([Capture List](http://www.russbishop.net/swift-capture-lists)) 已经能够很好的让你获取一个`weak self`来避免循环引用了，但这还达不到我们的要求，只有`weak`是构不成“weak/strong dance”滴。
...
这个方法是 [@jtbandes](https://twitter.com/jtbandes) 这哥们想的，大概会是这样：
...
关于Swift中 “Weak/Strong Dance”，中的Weak部分，大家可以参阅喵大的这篇文章 [内存管理,*weak* 和 *unowned*](https://www.baidu.com/link?url=4d2OoIpoCqnc98N8TJ4PiMR2qoqCe4qm-9LnTIUU4yzHwwVR6KaO1EOOSYNuAowX&wd=&eqid=fb7afdf00006201300000005567b8a3c) 。
